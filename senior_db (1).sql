...
CREATE TABLE `senior_profiles` (
  ...
  `sickly_conditions` varchar(255) DEFAULT NULL,
  `disability` varchar(255) DEFAULT NULL,
  `receives_pension` varchar(5) DEFAULT NULL,
  `pension_sources` varchar(255) DEFAULT NULL,
  `status` varchar(50) DEFAULT 'Active',
  `archive_remarks` varchar(255) DEFAULT NULL,
...
INSERT INTO `senior_profiles` (`senior_id`, `barangay_assigned`, `zone`, `municipality`, `province`, `first_name`, `middle_name`, `last_name`, `gender`, `birthday`, `age`, `birth_place`, `religion`, `civil_status`, `spouse_name`, `spouse_contact_number`, `address`, `educational_attainment`, `sickly_conditions`, `disability`, `receives_pension`, `pension_sources`, `status`, `archive_remarks`, `other_remarks`) VALUES
('112654', 'Bitag Grande', 'zone 7', 'Baggao', 'Cagayan', 'richmond', 'rosete', 'rosete', 'Male', '1930-11-11', 93, 'baggao', 'rc', 'Single', NULL, NULL, NULL, 'Elementary', 'Hypertension', NULL, NULL, NULL, 'Active', NULL, NULL),
('123456', 'Asassi', '2', 'Baggao', 'Cagayan', 'NECIO00BBB', 'KUDARAT', 'AMBOLIGAN', 'Male', '1920-11-11', 103, 'BAGGAO', 'RC', 'Single', NULL, NULL, NULL, 'Vocational', 'Asthma, Tuberculosis', NULL, 'No', NULL, 'Active', NULL, NULL);
